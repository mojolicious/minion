...
subtest 'Abstract methods' => sub {
  ...
  eval { Minion::Backend->dispatch_schedules };
  like $@, qr/Method "dispatch_schedules" not implemented by subclass/, 'right error';
  ...
  eval { Minion::Backend->list_schedules };
  like $@, qr/Method "list_schedules" not implemented by subclass/, 'right error';
  ...
  eval { Minion::Backend->pause_schedule };
  like $@, qr/Method "pause_schedule" not implemented by subclass/, 'right error';
  ...
  eval { Minion::Backend->resume_schedule };
