...
day-of-week), with C<*>, C<*/N>, C<a-b>, C<a-b/N> and comma separated lists. Times are interpreted in UTC. Updating
a schedule with the same cron expression preserves its current firing time; changing the expression recomputes it.
Schedules are dispatched by L<Minion::Worker> in the background, see L</"dispatch_schedules">.
